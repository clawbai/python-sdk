...
- register
- attest
- call /v1/check (workspace-key authenticated)
...
def main() -> int:
    ...
    ap.add_argument("--api-key", required=True, help="Workspace API key for /v1/check")
    args = ap.parse_args()
    ...
    provider = WorkspaceControlPlane(client=ClawbClient(base_url=args.base_url), api_key=args.api_key)
